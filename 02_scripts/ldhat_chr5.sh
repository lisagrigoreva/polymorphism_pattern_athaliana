...
export list_samples=${DATAdir}/chr5/vcf_files.txt
...
# Run LDhat
./LDhat/interval -seq ${DATAdir}/chr5/${sample}.vcf.ldhat.sites -loc ${DATAdir}/chr5/${sample}.vcf.ldhat.locs  -lk 54lk.txt  -its 60000000 -bpen 5 -samp 40000  -prefix ./chr5/${sample}.
# Collect stat
#./LDhat/stat -input ${DATAdir}/chr5/${sample}.rates.txt  -loc  ${DATAdir}/chr5/${sample}.vcf.ldhat.locs  -prefix ${DATAdir}/chr5/${sample}
