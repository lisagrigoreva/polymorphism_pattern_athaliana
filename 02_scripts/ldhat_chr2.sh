...
export list_samples=${DATAdir}/chr2/vcf_files.txt
...
# Run LDhat
#./LDhat/interval -seq ${DATAdir}/chr2/${sample}.vcf.ldhat.sites -loc ${DATAdir}/chr2/${sample}.vcf.ldhat.locs  -lk 54lk.txt  -its 60000000 -bpen 5 -samp 40000  -prefix ./chr2/${sample}.
# Collect stat
./LDhat/stat -input ${DATAdir}/chr2/${sample}.rates.txt  -loc  ${DATAdir}/chr2/${sample}.vcf.ldhat.locs  -prefix ${DATAdir}/chr2/${sample}
