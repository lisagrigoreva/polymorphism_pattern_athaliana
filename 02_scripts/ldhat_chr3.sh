...
export list_samples=${DATAdir}/chr3/vcf_files.txt
...
# Run LDhat
./LDhat/interval -seq ${DATAdir}/chr3/${sample}.vcf.ldhat.sites -loc ${DATAdir}/chr3/${sample}.vcf.ldhat.locs  -lk 54lk.txt  -its 60000000 -bpen 5 -samp 40000  -prefix ./chr3/${sample}
# Collect stat
#./LDhat/stat -input ${DATAdir}/chr3/${sample}.rates.txt  -loc  ${DATAdir}/chr3/${sample}.vcf.ldhat.locs  -prefix ${DATAdir}/chr3/${sample}
